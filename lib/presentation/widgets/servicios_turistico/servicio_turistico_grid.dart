...
class ServiciosTuristicosGrid extends ConsumerWidget {
  ...
  ServiciosTuristicosGrid({required this.query});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final serviciosAsyncValue = ref.watch(serviciosTuristicosProvider);

    return serviciosAsyncValue.when(
      data: (servicios) {
        // Filtrar los servicios según el nombre y la búsqueda
        final filtrados = servicios.where((servicio) {
          final nombre = servicio.nombre.toLowerCase();
          final direccion = servicio.direccion.toLowerCase();
        ...
        return filtrados.isNotEmpty
          ...
          itemBuilder: (context, index) {
            ...
            : const Center(child: Text('No hay servicios turísticos disponibles.'));
      },
